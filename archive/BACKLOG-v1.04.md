...
Version: v1.04 | Updated: 12 June 2026
...
| BL-28 | Date format US/UK confusion in form | FIXED | v1.04 |
| BL-29 | Suspension toggle defaults ON | FIXED | v1.04 |
| BL-30 | Commit button visible without token | FIXED | v1.01 |
| BL-32 | Legacy iPad / iOS 10.3.3 safe rendering | BUILT | v1.04 |
| BL-33 | Legacy-safe manual update mode | BUILT | v1.04 |
| BL-34 | Render failure fallback message | BUILT | v1.04 |
| BL-35 | Debug footer showing render mode / browser | BUILT | v1.04 |
| BL-36 | Print-friendly light mode | BUILT | v1.04 |
| BL-37 | Safe public backlog file | BUILT | v1.04 |
| BL-38 | Font fallback if Google Fonts fail | BUILT | v1.04 |
